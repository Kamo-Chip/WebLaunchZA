  ...
  return (
    ...
    >
      ...
      <div className="text-container">
        ...
        <div>
          <p>
            First impressions are everything in today's fast-paced environment.
            If you do not give consumers a reason to pick your service within a
            short amount of time they lose interest and move on to a competitor
            that satisfies their needs. Now the question is how do you gain the
