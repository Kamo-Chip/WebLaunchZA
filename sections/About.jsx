      ...
      <div className="text-container">
        ...
        <div>
          ...
          <p>
            ...
            so we cut out the fluff of traditional web development agencies by
            making you pay for only what you need.
          </p>
          <p>
          ...
          <p>
            Having a{" "}
            <Link
              href="/blog/posts/why-your-business-needs-a-website"
            ...
            and a{" "}
            <Link
              href="/blog/posts/how-to-advertise-on-google-for-free"
              style={{ color: "rgb(0, 106, 255)" }}
            >
              Google Business Profile
            </Link>{" "}
            builds trust between you and potential clients because it lets them
            know that you are legit. This increases the chances of them becoming
            paying customers. Our services have proven to be an extremely
            effective way of improving your visibility, and we can confidently
            say that we will make you seen! So let us handle the hassle of
            putting your business online so that you can focus on doing what you
            do best!
          </p>
        </div>
      </div>
